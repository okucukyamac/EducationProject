...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230214200019_InitialCreate")]
            ...
            modelBuilder.Entity("Entities.Concrete.Article", b =>
                {
                    ...
                    b.Property<string>("InsertByName")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2023, 2, 14, 23, 0, 19, 121, DateTimeKind.Local).AddTicks(9670),
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(726),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(960),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(1701),
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(1765),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(1766),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(1772),
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(1774),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 122, DateTimeKind.Local).AddTicks(1775),
            ...
            modelBuilder.Entity("Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 124, DateTimeKind.Local).AddTicks(4135),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 124, DateTimeKind.Local).AddTicks(4144),
                            Name = "C#",
                        ...
                        new
                        {
                            ...
                            Description = "C++ Programlama Dili ile ilgili En Güncel Bilgiler",
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 124, DateTimeKind.Local).AddTicks(4155),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 124, DateTimeKind.Local).AddTicks(4156),
                            Name = "C++",
                            Note = "C++ Blog Kategorisi"
                        },
                        new
                        {
                            ...
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 124, DateTimeKind.Local).AddTicks(4160),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 124, DateTimeKind.Local).AddTicks(4161),
                            Name = "JavaScript",
            ...
            modelBuilder.Entity("Entities.Concrete.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArticleId = 1,
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 125, DateTimeKind.Local).AddTicks(9199),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 125, DateTimeKind.Local).AddTicks(9206),
                        ...
                        new
                        {
                            ...
                            ArticleId = 3,
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 125, DateTimeKind.Local).AddTicks(9216),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 125, DateTimeKind.Local).AddTicks(9217),
                            Note = "C++ Makale yorumu",
                            Text = "Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz.Kökleri M.Ö. 45 tarihinden bu yana klasik Latin edebiyatına kadar uzanan 2000 yıllık bir geçmişi vardır.Virginia'daki Hampden-Sydney College'dan Latince profesörü Richard McClintock,\r\n                    bir Lorem Ipsum pasajında geçen ve anlaşılması en güç sözcüklerden biri olan 'consectetur' sözcüğünün klasik edebiyattaki örneklerini incelediğinde kesin bir kaynağa ulaşmıştır.Lorm Ipsum, Çiçero tarafından M.Ö. 45 tarihinde kaleme alınan (İyi ve Kötünün Uç Sınırları) eserinin 1.10.32 ve 1.10.33 sayılı bölümlerinden gelmektedir.Bu kitap, ahlak kuramı üzerine bir tezdir ve Rönesans döneminde çok popüler olmuştur.Lorem Ipsum pasajının ilk satırı olan Lorem ipsum dolor sit amet 1.10.32 sayılı bölümdeki bir satırdan gelmektedir."
                        },
                        new
                        {
                            ...
                            ArticleId = 3,
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 125, DateTimeKind.Local).AddTicks(9220),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 125, DateTimeKind.Local).AddTicks(9221),
            ...
            modelBuilder.Entity("Entities.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 127, DateTimeKind.Local).AddTicks(455),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "Admin",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 127, DateTimeKind.Local).AddTicks(462),
                            Name = "Admin",
                            Note = "Admin Rolüdür."
                        });
                });
            ...
            modelBuilder.Entity("Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Oğuzhan",
                            InsertByName = "InitialCreate",
                            InsertDate = new DateTime(2023, 2, 14, 23, 0, 19, 132, DateTimeKind.Local).AddTicks(2658),
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Küçükyamaç",
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2023, 2, 14, 23, 0, 19, 132, DateTimeKind.Local).AddTicks(2671),
